                        ...
                        <div class="cart-grid-right col-xs-12 col-lg-3">
                                ...
                                <div class="cart-detailed-totals">
                                    ...
                                    <div class="">
                                        <div class="cart-summary-line cart-total">
                                            <span class="label">Total:</span><span class="value">{{$basket  -> subTotal()}}</span>
                                        </div>
                                    </div>
                            ...
                            <div class="blockreassurance_product">
                              ...
                              <span class="item-product">
                                   <img class="svg invisible" src="{{ asset('assets/images/insurance.png') }}">
                                    &nbsp;
                                </span>
                                ...
                                <div>
                                <span class="item-product">
                                    <img class="svg invisible" src="{{ asset('assets/images/truck.png') }}">
                                    &nbsp;
                                </span>
