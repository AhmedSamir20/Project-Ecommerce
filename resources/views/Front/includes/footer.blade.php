<footer class="footer footer-three">
    <div class="inner-footer">
        <div class="container">
            <div class="row">
                <div class="nov-row footer-top " data-nov-full-width="true"><div class="nov-row-wrap row"><div class="nov-modules col-lg-12 col-md-12 "><div class="block nov-wrap"><div class="title_block">{{ __('site/site.welcome') }}</div><div class="block_newsletter">
