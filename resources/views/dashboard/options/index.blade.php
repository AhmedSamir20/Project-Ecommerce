                                    ...
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th>{{__('admin/pages.O-Name')}}</th>
                                                <th>{{__('admin/pages.O-Name-slug')}}</th>
                                                <th>{{__('admin/pages.O-process')}}</th>
                                                <th>{{__('admin/pages.O-attribute')}}</th>
                                                <th>{{__('admin/pages.O-product')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
