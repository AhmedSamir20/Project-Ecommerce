    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">{{__('admin/settings.Welcome')}}
                  <span
                      class="user-name text-bold-700">  {{auth('admin')->user()->name}} </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('edit.profile')}}"><i
                                    class="ft-user"></i>{{__('admin/editProfile.profile')}} </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('admin.logout')}}"><i class="ft-power"></i> {{__('admin/editProfile.logout')}} </a>
                        </div>
                    </li>
                    {{-----------------------------strat lang-------------------}}
                    <li class="dropdown dropdown-user nav-item">
