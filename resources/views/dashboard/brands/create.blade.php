                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">  {{__('admin/brand.addBrand')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="" id="basic-layout-form">  {{__('admin/brand.addBrand')}} </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.brands.store')}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i><strong>{{__('admin/brand.brandData')}} </strong></h4>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                            ...
                                            <div class="form-actions">
                                                <a type="button" href="{{route('admin.brands')}}" class="btn btn-warning mr-1" type="button">
